...
- Sürüm 0.4.0+6 (#32: kasa içi gizli tarayıcı, INTERNET izni yalnızca tarayıcı için; önceki 0.3.2+5 #30: `full`'da kilitliyken iş uygulamaları gizlenir; önceki 0.3.1+4 #28: `play`'de Pro taslağı gizli, gizlilik bağlantısı, öne çıkan görsel); test ön sürümü `v0.4.0-test` (önceki `v0.3.2-test`, `v0.3.1-test`, `v0.3.0-test`) (iki arm64 APK, debug imzalı, mağaza için değil): `play` çeşidi (`com.offerforge.gizlialan`, İkinci telefon yok, cihaz yöneticisi bileşeni yok) ve `full` çeşidi (`com.offerforge.gizlialan.full`, İkinci telefon). #11: sahibi "ikisini de üretip deneyelim" dedi; Play'e hangisinin gideceği test sonrası sahibin kararı. Önceki: `v0.2.0-test`.
